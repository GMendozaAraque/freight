                ...
                <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-4 p-2 md:p-12 h-5/6" data-aos="zoom-in">
                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            Still Relying on Referrals? Your Competitors Are Booking 3x Inspections Online.
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">You offer free roof inspections, but the best leads are scrolling past. We specialize in turning Facebook and Instagram into a predictable appointment machine—no more guessing. We handle the setup and deliver interested people so you invest your time in closing, not chasing.</div>
